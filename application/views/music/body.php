                 ...
                 <div class="header_bottom_border">
                     <div class="row align-items-center">
                         <div class="col-xl-3 col-lg-2">
                             <div class="logo">
                                 <a href="index.html">
                                     <img src="<?= base_url(); ?>assets/music/img/logo.png" alt="">
                                 </a>
                             </div>
                         </div>
                 ...
                 <div class="row align-items-center">
                     <div class="col-xl-9 col-md-9">
                         <div class="music_field">
                             <div class="thumb">
                                 <img src="<?= base_url(); ?>assets/music/img/music_man/1.png" alt="">
                             </div>
         ...
         <div class="row align-items-center">
             <div class="col-xl-5 col-md-6">
                 <div class="about_thumb">
                     <img class="img-fluid" src="<?= base_url(); ?>assets/music/img/about/about_1.png" alt="">
                 </div>
             </div>
             <div class="col-xl-7 col-md-6">
                 <div class="about_info">
                     ...
                     <div class="signature">
                         <img src="<?= base_url(); ?>assets/music/img/about/signature.png" alt="">
                     </div>
                 </div>
             </div>
         </div>
         ...
         <div class="row no-gutters">
             <div class="col-xl-3 col-lg-3 col-md-6">
                 <div class="single_video">
                     <div class="thumb">
                         <img src="<?= base_url(); ?>assets/music/img/video/1.png" alt="">
                     </div>
             ...
             <div class="col-xl-3 col-lg-3 col-md-6">
                 <div class="single_video">
                     <div class="thumb">
                         <img src="<?= base_url(); ?>assets/music/img/video/2.png" alt="">
                     </div>
                     <div class="hover_elements">
                         <div class="video">
                             <a class="popup-video" href="https://www.youtube.com/watch?v=Hzmp3z6deF8">
             ...
             <div class="col-xl-3 col-lg-3 col-md-6">
                 <div class="single_video">
                     <div class="thumb">
                         <img src="<?= base_url(); ?>assets/music/img/video/3.png" alt="">
                     </div>
                     <div class="hover_elements">
                         <div class="video">
                             <a class="popup-video" href="https://www.youtube.com/watch?v=Hzmp3z6deF8">
             ...
             <div class="col-xl-3 col-lg-3 col-md-6">
                 <div class="single_video">
                     <div class="thumb">
                         <img src="<?= base_url(); ?>assets/music/img/video/4.png" alt="">
                     </div>
                     <div class="hover_elements">
                         <div class="video">
                             <a class="popup-video" href="https://www.youtube.com/watch?v=Hzmp3z6deF8">
             ...
             <div class="col-xl-10">
                 <div class="row align-items-center">
                     <div class="col-xl-9 col-md-9">
                         <div class="music_field">
                             <div class="thumb">
                                 <img src="<?= base_url(); ?>assets/music/img/music_man/2.png" alt="">
                             </div>
                             <div class="audio_name">
                                 <div class="name">
                                     <h4>Frando Kally</h4>
             ...
             <div class="col-xl-10">
                 <div class="row align-items-center">
                     <div class="col-xl-9 col-md-9">
                         <div class="music_field">
                             <div class="thumb">
                                 <img src="<?= base_url(); ?>assets/music/img/music_man/3.png" alt="">
                             </div>
                             <div class="audio_name">
                                 <div class="name">
                                     <h4>Frando Kally</h4>
     ...
     <div class="container">
         ...
         <div class="row grid">
             <div class="col-xl-5 col-lg-5 grid-item cat1 col-md-6">
                 <div class="single-gallery mb-30">
                     <div class="portfolio-img">
                         <img src="<?= base_url(); ?>assets/music/img/gallery/1.png" alt="">
                     </div>
             ...
             <div class="col-xl-7 col-lg-7 grid-item cat3 cat4 col-md-6">
                 <div class="single-gallery mb-30">
                     <div class="portfolio-img">
                         <img src="<?= base_url(); ?>assets/music/img/gallery/2.png" alt="">
                     </div>
                     <div class="gallery_hover">
             ...
             <div class="col-xl-4 col-lg-6 grid-item cat4 col-md-6">
                 <div class="single-gallery mb-30">
                     <div class="portfolio-img">
                         <img src="<?= base_url(); ?>assets/music/img/gallery/3.png" alt="">
                     </div>
                     <div class="gallery_hover">
             ...
             <div class="col-xl-4 col-lg-6 grid-item cat2 col-md-6">
                 <div class="single-gallery mb-30">
                     <div class="portfolio-img">
                         <img src="<?= base_url(); ?>assets/music/img/gallery/4.png" alt="">
                     </div>
                     <div class="gallery_hover">
             ...
             <div class="col-xl-4 col-lg-6 grid-item cat2 col-md-6">
                 <div class="single-gallery mb-30">
                     <div class="portfolio-img">
                         <img src="<?= base_url(); ?>assets/music/img/gallery/5.png" alt="">
                     </div>
                     <div class="gallery_hover">
                 ...
                 <div class="col-xl-5 col-md-5 offset-xl-1">
                     <div class="footer_widget">
                         ...
                         <ul>
                             ...
                             <li><a href="#"><?php echo $mphone ?>
                                 </a></li>
                             <li><a href="#"><?php echo $mcity ?></a></li>
                         </ul>
             ...
             <div class="row">
                 <div class="col-xl-7 col-md-6">
                     <p class="copy_right">
                         ...
                         </script> All rights reserved | <?php echo $author ?></a>
                         <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                     </p>
                 </div>
                 <div class="col-xl-5 col-md-6">
