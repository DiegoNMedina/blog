            ...
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-3 mb-3 mb-lg-0">
                    <div class="d-flex quick-info-2">
                        ...
                        <div class="text">
                            <strong class="d-block heading">Ubicación</strong>
                            <span class="excerpt"><?= $tcity ?></span>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-6 col-lg-3 mb-3 mb-lg-0">
                    <div class="d-flex quick-info-2">
                        ...
                        <div class="text">
                            <strong class="d-block heading">Llámame</strong>
                            <span class="excerpt"><a href="tel://<?php echo $tphone ?>"><?= $tphone ?></a></span>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-6 col-lg-3 mb-3 mb-lg-0">
                    <div class="d-flex quick-info-2">
                        ...
                        <div class="text">
                            <strong class="d-block heading">Agenda tu cita</strong>
                            <span class="excerpt"><a href="#"><?= $theraphymail ?></a></span>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-6 col-lg-3 mb-3 mb-lg-0">
