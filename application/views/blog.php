	...
	<div class="container">
		<div class="row justify-content-center pb-5">
			<div class="col-md-10 heading-section text-center ftco-animate">
				...
				<p>I studied information technology engineering, but my love for web development started in high school. I am starting in the development of software in a professional way.</p>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6">
	...
	<div class="container">
		<div class="row justify-content-center py-5 mt-5">
			<div class="col-md-12 heading-section text-center ftco-animate">
				...
				<p>I think my specialty is web development but I can also develop applications. ;)</p>
			</div>
		</div>
		<div class="row">
	...
	<div class="container">
		<div class="row justify-content-center pb-5">
			<div class="col-md-12 heading-section text-center ftco-animate">
				...
				<p>Some of my skills in software development.</p>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-md-6 animate-box">
				<div class="progress-wrap ftco-animate">
					<h3>jQuery</h3>
					<div class="progress">
						<div class="progress-bar color-2" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width:70%">
							<span>70%</span>
						</div>
					</div>
				</div>
			...
			<div class="col-md-6 animate-box">
				<div class="progress-wrap ftco-animate">
					<h3>C#</h3>
					<div class="progress">
						<div class="progress-bar color-6" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="width:85%">
							<span>85%</span>
						</div>
					</div>
				</div>
			...
			<div class="col-md-6 animate-box">
				<div class="progress-wrap ftco-animate">
					<h3>Git</h3>
					<div class="progress">
						<div class="progress-bar color-6" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:50%">
							<span>50%</span>
						</div>
					</div>
				</div>
		...
		<div class="row mb-5">
			<div class="col-md">
				<div class="ftco-footer-widget mb-4">
					...
					<p>I am a tech-loving developer, always ready to learn.</p>
		...
		<div class="row">
			<div class="col-md-12 text-center">
				<p>
					...
					</script> All rights reserved | <?php echo $name ?></a>
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
				</p>
			</div>
		</div>
