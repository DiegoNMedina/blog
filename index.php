	...
	<div class="pages-stack">
		...
		<div class="page" id="page-home">
			...
			<header class="bp-header cf">
				...
				<h1 class="bp-header__title">I'm Eng Diego Nuñez</h1>
				<p class="bp-header__desc">I'm software developer and  <a href="https://dribbble.com/shots/2286042-Stacked-navigation">these are some of my projects</a></p>
				<nav class="bp-nav">
		...
		<div class="page" id="page-blog">
			...
			<img class="poster" src="images/1.webp" alt="img01" />
		</div>
